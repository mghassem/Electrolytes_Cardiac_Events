...
MAGNESIUM_FILTERED AS 
(
SELECT * FROM MAGNESIUM_UNFILTERED
INNER JOIN FILTER 
ON FILTER.ICUSTAY_ID = MAGNESIUM_UNFILTERED.ICUSTAY_ID
)
SELECT * FROM MAGNESIUM_FILTERED LIMIT 10;
